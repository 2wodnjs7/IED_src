...
float dist_min, dist_max, dist_raw, dist_prev, dist_ema, bf_dist_raw; // unit: mm
...
// get a distance reading from the USS
  ...
  if(dist_raw == 0) dist_raw = bf_dist_raw;
  else {
    bf_dist_raw = dist_raw;
  }
...
if(dist_raw < 180.0) {
     ...
     myservo.writeMicroseconds(map(dist_ema-180.0,0,180,500,2460));
