...
//#define _DUTY_MAX 2180
#define _DUTY_MAX 1900 

// Servo speed control
#define _SERVO_ANGLE 20 // angle b/w DUTY_MAX and DUTY_MIN
#define _SERVO_SPEED 1 // servo speed limit (deg/sec)

// Event periods
#define _INTERVAL_DIST 25 // distance sensor interval (ms)
#define _INTERVAL_SERVO 20 // servo interval (ms)
#define _INTERVAL_SERIAL 20 // serial interval (ms)

// PID parameters
#define _KP 10.0 // proportional gain ****
...
// Fiter variables
float x[7] = {82, 131, 170, 195, 217, 238, 256};
...
void loop() {
  ...
  if(event_serial) {
    event_serial = false;
    Serial.print("min:0,max:500,dist_raw:");
